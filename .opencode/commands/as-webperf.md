---
description: Run a web performance audit via the web-performance-auditor subagent
---
...
Delegate to the `web-performance-auditor` subagent (mention `@web-performance-auditor`). Pass it explicitly:
...
Return the full audit report to the user. No synthesis or merge step is needed - this is a single-subagent command.
