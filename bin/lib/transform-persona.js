...
// `web-debugger` depends on the always-on `chrome-devtools-mcp` extension's
// `chrome_devtools__*` tools (loaded into its coms-peer process); the
...
export const PI_ONLY_PERSONAS = ["bowser", "web-debugger", "orchestrator"];
